...
//GPS parameter
softSerial serial_connection(GPIO4, GPIO3); //RX=pin 10, TX=pin 11
...
uint32_t appTxDutyCycle = 60000*0.6;
...
static void prepareTxFrame( uint8_t port )
{
  ...
  */
    Serial.println("Start Prepare payload ");
    ...
    Serial.println("Done prepare Payload ");
